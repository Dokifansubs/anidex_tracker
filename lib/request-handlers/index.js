...
var stopPeer = function(peer, res) {
    ...
    console.log('Peer: ' + peer.peer_id + ' stopped torrent: ' + peer.info_hash + ' left: ' + peer.info.left);
...
var startPeer = function(peer, res) {
    ...
    console.log('Peer: ' + peer.peer_id + ' started torrent: ' + peer.info_hash + ' left: ' + peer.info.left);
...
var updatePeer = function(peer, res) {
    ...
    console.log('Peer: ' + peer.peer_id + ' update torrent: ' + peer.info_hash + ' left: ' + peer.info.left);
